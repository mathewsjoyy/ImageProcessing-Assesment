...
% Display our segmentation results to the screen
...
% Custom Function Defintions Below ----------------------------------------
...
function [labeled_image, cmap] = screw_washer_detection(input_img)
    ...
    %figure;imshow(I_gray_scale_bi);title('Re-sized Image');
    %figure;histogram(I_gray_scale_bi);title('Histogram (before enhancement)');
    ...
    %figure;imshow(I_gray_scale_bi_enhanced);title('Enhanced Image');
    %figure;histogram(I_gray_scale_bi_enhanced);
    ...
    %figure;imshow(edgeDetectionCanny);title("Edge Detection Result - Canny")
